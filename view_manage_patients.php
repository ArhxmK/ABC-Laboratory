...
$db = new Database();
$result = $db->executeQuery("SELECT * FROM patients");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete"])) {
    ...
    $deleteQuery = "DELETE FROM patients WHERE PID = '$deleteId'";
    $db->executeQuery($deleteQuery);
    header("Location: view_manage_patients.php");
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="container">
        ...
        foreach ($records as $record) {
            ...
            echo '<strong>Patient Name:</strong> ' . $record['patientName'] . '<br>';
        ...
        <script>
            function deleteRecord(patientId) {
                if (confirm("Are you sure you want to delete this record?")) {
                    ...
                    form.setAttribute("action", "view_manage_patients.php");
